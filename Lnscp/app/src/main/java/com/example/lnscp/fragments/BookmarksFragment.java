...
public class BookmarksFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View headerView = inflater.inflate(R.layout.header_with_back_button, null);
        if (headerView != null) {
            monumentsList.addHeaderView(headerView);
            
            // Set click listener for back button
            View backButton = headerView.findViewById(R.id.back_button);
            if (backButton != null) {
            ...
            if (titleView != null) {
                titleView.setText("Bookmarked Monuments");
            }
        }
    ...
    private void loadBookmarks() {
        try {
            List<Monument> monuments = dbHelper.getBookmarkedMonuments();
            if (monuments.isEmpty()) {
                Toast.makeText(requireContext(), "No bookmarked monuments", Toast.LENGTH_SHORT).show();
            }
            ...
            e.printStackTrace();
            Toast.makeText(requireContext(), "Error loading bookmarks: " + e.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
